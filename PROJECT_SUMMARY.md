...
### Текущие затраты (разработка MVP)

| Категория | Часы (среднее) | Стоимость |
| :--- | :--- | :--- |
| Инфраструктура и DevOps | 13 | ~36,400 руб. |
| Бэкенд (API и Воркеры) | 35 | ~98,000 руб. |
| Фронтенд (MVP) | 16 | ~44,800 руб. |
| Управление и Документация| 6 | ~16,800 руб. |
| **Итого (MVP):** | **70 часов** | **~196,000 руб.** |

### Стоимость будущих работ (до релиза)

| Роль | Часы (среднее) | Стоимость |
| :--- | :--- | :--- |
| Программисты (Backend + Frontend) | 240 | ~672,000 руб. |
| DevOps-инженер | 35 | ~98,000 руб. |
| UX/UI Дизайнер | 50 | ~140,000 руб. |
| Project Manager | 60 | ~168,000 руб. |
| **Итого (будущие работы):** | **385 часов** | **~1,078,000 руб.** |

---

### **Общая стоимость проекта**

*   **Полное время разработки**: ~455 часов
*   **Итоговая стоимость (MVP + Будущие работы)**: **~1,274,000 рублей**
