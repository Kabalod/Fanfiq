...
- Умное преобразование количества знаков в слова (74 255 зн. → ~13 500 слов)
- Поддержка авторизации через cookies для платного контента
- Продвинутая очистка HTML от Author.Today специфических элементов
- Санитизация HTML и валидация через Pydantic
- Интеграция с Celery очередями
- Полностью протестирован на реальных данных
